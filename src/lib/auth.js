            ...
            async authorize(credentials) {
                try {
                    ...
                    if (process.env.CLOUDFLARE_TURNSTILE_SECRET_KEY) {
                        if (!turnstileToken) {
                            console.warn("Turnstile: Login attempt without token.");
                            throw new Error("Vérification Anti-Bot manquante. Merci d'actualiser la page.");
                        }
                        ...
                        if (!verifyJson.success) {
                            ...
                            throw new Error("Échec de la vérification Anti-Bot. Veuillez réessayer.");
                        }
                    }
