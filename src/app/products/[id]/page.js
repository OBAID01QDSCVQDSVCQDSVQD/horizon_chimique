                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-3 mt-auto">
                            <Link href="/contact" className="flex-1 sm:flex-none bg-slate-900 text-white px-6 py-3 rounded-lg font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg text-sm">
                                Demander un Devis <ArrowRight size={16} />
                            </Link>

                            <button
                                onClick={async () => {
                                    setDownloadingPdf(true); // Add this state
                                    try {
